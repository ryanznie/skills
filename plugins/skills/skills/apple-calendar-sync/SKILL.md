...
For persistent repo-local setup, create `apple-calendar-sync/.env.calendar` inside `skills/`. The script loads that file automatically, or you can override it with `--env-file`.
